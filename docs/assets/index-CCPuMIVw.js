const __vite__fileDeps=["assets/browserAll-Cz63x-bA.js","assets/webworkerAll-BxS6IevQ.js","assets/colorToUniform-lpqUYCKd.js","assets/getBatchSamplersUniformGroup-BvYFkh9i.js","assets/WebGPURenderer-DfgvsPrw.js","assets/SharedSystems-tICeE-bq.js","assets/WebGLRenderer-Cmd2o7DO.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
...
`;let An=null,Qr=class{constructor(){An||(An=URL.createObjectURL(new Blob([Px],{type:"application/javascript"}))),this.worker=new Worker(An)}};Qr.revokeObjectURL=function(){An&&(URL.revokeObjectURL(An),An=null)};const Tx=`(function () {
    'use strict';
...
}`;const sh=(e,t)=>{const n=e.__vccOpts||e;for(const[s,i]of t)n[s]=i;return n},Wx={__name:"Shader",props:{shader:String},setup(e){se("WEBGL.NANONUM.COM");const t=e,n=se(!1);let s;const i=o=>{s.getFilter().resources.timeUniforms.uniforms.u_time+=.01*o.deltaTime};async function r(){window.background=new To,await window.background.init({id:"canvas_background",background:"#000",backgroundAlpha:0,resizeTo:window,resolution:window.devicePixelRatio});const o=t.shader??`#version 300 es
    precision highp float;
    uniform float u_time;// 0-1
    out vec4 fragColor;
    void main(){
      fragColor = vec4(0.0, 0.0, pow(sin(u_time * 4.41) * 0.5 + 0.5, .4), 1.0);
    }`;s=new Hx({stage:window.background.stage,fragment:o,vertex:$x,uniforms:{}}),window.background.stage.filters=[s.getFilter()],window.background.ticker.maxFPS=60,window.background.ticker.add(i),window.background.canvas.setAttribute("id","canvas_app"),document.body.appendChild(window.background.canvas),n.value=!0}return In(()=>{r(t.shader)}),pi(()=>{n.value=!1,window.background.ticker&&window.background.ticker.remove(i),window.background&&window.background.destroy({removeView:!0,stageOptions:{children:!0,texture:!0,baseTexture:!0}})}),mi(()=>{s.destroy(),window.background=null}),wn(()=>t.shader,()=>{console.log(),n.value&&s.setFragment(t.shader)}),(o,a)=>null}},Vx=sh(Wx,[["__scopeId","data-v-535df499"]]);var Xx=`precision highp float;
...
void main(void)
{
    ...
    uSize = uInputSize;
    uOffset = uOutputFrame;
}`;const Bl=(e,t)=>{e.x=t.x,e.y=t.y,e.width=t.width,e.height=t.height,e.top=t.top,e.right=t.right,e.bottom=t.bottom,e.left=t.left},zl=e=>({x:e.x,y:e.y,width:e.width,height:e.height,top:e.top,right:e.right,bottom:e.bottom,left:e.left}),Yx={class:"dev"},qx=["width","height"],Kx={__name:"Thumbnail",props:{shader:String,alt:String,saturation:{type:Number,default:1},show:Boolean,selected:Boolean,active:Boolean,width:Number,height:Number,className:String},setup(e){const t=e,n=se();let s,i;const r={};let o;const a=new Tn,l=c=>{n.value&&(Bl(r,zl(n.value.getBoundingClientRect())),s.x=r.x,s.y=r.y,a.x=r.x,a.y=r.y,a.width=r.width,a.height=r.height),(t.active===!0||!t.selected)&&(o.resources.timeUniforms.uniforms.u_time+=.01*c.deltaTime),o.resources.localUniforms.uniforms.u_position.y=r.y,o.resources.localUniforms.uniforms.u_position.x=r.x,o.resources.localUniforms.uniforms.u_posteffect_mix=!t.selected||t.active?1:t.saturation},u=c=>{const h=`
    vec2 aPosition = vec2(
  ...
  `),f=f.replace(/void main\([void]*\)[\s]*{/ig,`void main(){${h}`),f=f.replace(/.*}$/,"fragColor.rgb=mix(vec3(min(1.0,fragColor.r+fragColor.g+fragColor.b))*0.3,fragColor.rgb,u_posteffect_mix);}"),f};return In(async()=>{await Yn.load("./vite.svg"),Bl(r,zl(n.value.getBoundingClientRect())),o=new Mu({glProgram:fs.from({fragment:u(t.shader),vertex:Xx}),resolution:1,resources:{localUniforms:{u_resolution:{value:new _t(window.innerHeight,window.innerHeight),type:"vec2<f32>"},u_position:{value:new _t(0,0),type:"vec2<f32>"},u_posteffect_viewport:{value:new _t(r.width,r.height),type:"vec2<f32>"},u_posteffect_mix:{value:0,type:"f32"}},timeUniforms:{u_time:{value:0,type:"f32"}}}}),a.x=r.x,a.y=r.y,a.width=r.width,a.height=r.height,s=new vs,i=s.circle(r.width/2,r.width/2,r.width/2),s.fill({color:0}),a.mask=s,a.filters=[o],window.ui.stage.addChild(a),window.ui.stage.addChild(s),o.resources.localUniforms.uniforms.u_position.y=r.y,o.resources.localUniforms.uniforms.u_position.x=r.x,window.ui.ticker&&window.ui.ticker.add(l),window.addEventListener("resize",c=>{o.resources.localUniforms.uniforms.u_resolution.x=window.innerHeight,o.resources.localUniforms.uniforms.u_resolution.y=window.innerHeight,i.x=r.width/2,i.y=r.width/2,i.width=r.width,i.height=r.height,a.width=r.width,a.height=r.height,console.log(r.width)})}),wn(()=>t.show,c=>{a.visible=c}),mi(()=>{window.ui.ticker&&window.ui.ticker.remove(l),a.destroy()}),(c,h)=>(ge(),ze(Lt,null,[ie("div",Yx,Ds(e.active),1),ie("div",{class:_s("js-nnfxline"),ref_key:"el",ref:n,width:e.width,height:e.height},null,8,qx)],64))}},Zx=sh(Kx,[["__scopeId","data-v-ddf272e1"]]);var ih={update:null,begin:null,loopBegin:null,changeBegin:null,change:null,changeComplete:null,loopComplete:null,complete:null,loop:1,direction:"normal",autoplay:!0,timelineOffset:0},Uo={duration:1e3,delay:0,endDelay:0,easing:"easeOutElastic(1, .5)",round:0},Qx=["translateX","translateY","translateZ","rotate","rotateX","rotateY","rotateZ","scale","scaleX","scaleY","scaleZ","skew","skewX","skewY","perspective","matrix","matrix3d"],ri={CSS:{},springs:{}};function _e(e,t,n){return Math.min(Math.max(e,t),n)}function is(e,t){return e.indexOf(t)>-1}function mr(e,t){return e.apply(null,t)}var H={arr:function(e){return Array.isArray(e)},obj:function(e){return is(Object.prototype.toString.call(e),"Object")},pth:function(e){return H.obj(e)&&e.hasOwnProperty("totalLength")},svg:function(e){return e instanceof SVGElement},inp:function(e){return e instanceof HTMLInputElement},dom:function(e){return e.nodeType||H.svg(e)},str:function(e){return typeof e=="string"},fnc:function(e){return typeof e=="function"},und:function(e){return typeof e>"u"},nil:function(e){return H.und(e)||e===null},hex:function(e){return/(^#[0-9A-F]{6}$)|(^#[0-9A-F]{3}$)/i.test(e)},rgb:function(e){return/^rgb/.test(e)},hsl:function(e){return/^hsl/.test(e)},col:function(e){return H.hex(e)||H.rgb(e)||H.hsl(e)},key:function(e){return!ih.hasOwnProperty(e)&&!Uo.hasOwnProperty(e)&&e!=="targets"&&e!=="keyframes"}};function rh(e){var t=/\(([^)]+)\)/.exec(e);return t?t[1].split(",").map(function(n){return parseFloat(n)}):[]}function oh(e,t){var n=rh(e),s=_e(H.und(n[0])?1:n[0],.1,100),i=_e(H.und(n[1])?100:n[1],.1,100),r=_e(H.und(n[2])?10:n[2],.1,100),o=_e(H.und(n[3])?0:n[3],.1,100),a=Math.sqrt(i/s),l=r/(2*Math.sqrt(i*s)),u=l<1?a*Math.sqrt(1-l*l):0,c=1,h=l<1?(l*a+-o)/u:-o+a;function f(p){var g=t?t*p/1e3:p;return l<1?g=Math.exp(-g*l*a)*(c*Math.cos(u*g)+h*Math.sin(u*g)):g=(c+h*g)*Math.exp(-g*a),p===0||p===1?p:1-g}function d(){var p=ri.springs[e];if(p)return p;for(var g=1/6,m=0,y=0;;)if(m+=g,f(m)===1){if(y++,y>=16)break}else y=0;var v=m*g*1e3;return ri.springs[e]=v,v}return t?f:d}function Jx(e){return e===void 0&&(e=10),function(t){return Math.ceil(_e(t,1e-6,1)*e)*(1/e)}}var tv=function(){var e=11,t=1/(e-1);function n(c,h){return 1-3*h+3*c}function s(c,h){return 3*h-6*c}function i(c){return 3*c}function r(c,h,f){return((n(h,f)*c+s(h,f))*c+i(h))*c}function o(c,h,f){return 3*n(h,f)*c*c+2*s(h,f)*c+i(h)}function a(c,h,f,d,p){var g,m,y=0;do m=h+(f-h)/2,g=r(m,d,p)-c,g>0?f=m:h=m;while(Math.abs(g)>1e-7&&++y<10);return m}function l(c,h,f,d){for(var p=0;p<4;++p){var g=o(h,f,d);if(g===0)return h;var m=r(h,f,d)-c;h-=m/g}return h}function u(c,h,f,d){if(!(0<=c&&c<=1&&0<=f&&f<=1))return;var p=new Float32Array(e);if(c!==h||f!==d)for(var g=0;g<e;++g)p[g]=r(g*t,c,f);function m(y){for(var v=0,x=1,w=e-1;x!==w&&p[x]<=y;++x)v+=t;--x;var E=(y-p[x])/(p[x+1]-p[x]),M=v+E*t,z=o(M,c,f);return z>=.001?l(y,M,c,f):z===0?M:a(y,v,v+t,c,f)}return function(y){return c===h&&f===d||y===0||y===1?y:r(m(y),h,d)}}return u}(),ah=function(){var e={linear:function(){return function(s){return s}}},t={Sine:function(){return function(s){return 1-Math.cos(s*Math.PI/2)}},Expo:function(){return function(s){return s?Math.pow(2,10*s-10):0}},Circ:function(){return function(s){return 1-Math.sqrt(1-s*s)}},Back:function(){return function(s){return s*s*(3*s-2)}},Bounce:function(){return function(s){for(var i,r=4;s<((i=Math.pow(2,--r))-1)/11;);return 1/Math.pow(4,3-r)-7.5625*Math.pow((i*3-2)/22-s,2)}},Elastic:function(s,i){s===void 0&&(s=1),i===void 0&&(i=.5);var r=_e(s,1,10),o=_e(i,.1,2);return function(a){return a===0||a===1?a:-r*Math.pow(2,10*(a-1))*Math.sin((a-1-o/(Math.PI*2)*Math.asin(1/r))*(Math.PI*2)/o)}}},n=["Quad","Cubic","Quart","Quint"];return n.forEach(function(s,i){t[s]=function(){return function(r){return Math.pow(r,i+2)}}}),Object.keys(t).forEach(function(s){var i=t[s];e["easeIn"+s]=i,e["easeOut"+s]=function(r,o){return function(a){return 1-i(r,o)(1-a)}},e["easeInOut"+s]=function(r,o){return function(a){return a<.5?i(r,o)(a*2)/2:1-i(r,o)(a*-2+2)/2}},e["easeOutIn"+s]=function(r,o){return function(a){return a<.5?(1-i(r,o)(1-a*2))/2:(i(r,o)(a*2-1)+1)/2}}}),e}();function Do(e,t){if(H.fnc(e))return e;var n=e.split("(")[0],s=ah[n],i=rh(e);switch(n){case"spring":return oh(e,t);case"cubicBezier":return mr(tv,i);case"steps":return mr(Jx,i);default:return mr(s,i)}}function lh(e){try{var t=document.querySelectorAll(e);return t}catch{return}}function Ai(e,t){for(var n=e.length,s=arguments.length>=2?arguments[1]:void 0,i=[],r=0;r<n;r++)if(r in e){var o=e[r];t.call(s,o,r,e)&&i.push(o)}return i}function Ci(e){return e.reduce(function(t,n){return t.concat(H.arr(n)?Ci(n):n)},[])}function Rl(e){return H.arr(e)?e:(H.str(e)&&(e=lh(e)||e),e instanceof NodeList||e instanceof HTMLCollection?[].slice.call(e):[e])}function Go(e,t){return e.some(function(n){return n===t})}function Ho(e){var t={};for(var n in e)t[n]=e[n];return t}function to(e,t){var n=Ho(e);for(var s in e)n[s]=t.hasOwnProperty(s)?t[s]:e[s];return n}function Si(e,t){var n=Ho(e);for(var s in t)n[s]=H.und(e[s])?t[s]:e[s];return n}function ev(e){var t=/rgb\((\d+,\s*[\d]+,\s*[\d]+)\)/g.exec(e);return t?"rgba("+t[1]+",1)":e}function nv(e){var t=/^#?([a-f\d])([a-f\d])([a-f\d])$/i,n=e.replace(t,function(a,l,u,c){return l+l+u+u+c+c}),s=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(n),i=parseInt(s[1],16),r=parseInt(s[2],16),o=parseInt(s[3],16);return"rgba("+i+","+r+","+o+",1)"}function sv(e){var t=/hsl\((\d+),\s*([\d.]+)%,\s*([\d.]+)%\)/g.exec(e)||/hsla\((\d+),\s*([\d.]+)%,\s*([\d.]+)%,\s*([\d.]+)\)/g.exec(e),n=parseInt(t[1],10)/360,s=parseInt(t[2],10)/100,i=parseInt(t[3],10)/100,r=t[4]||1;function o(f,d,p){return p<0&&(p+=1),p>1&&(p-=1),p<1/6?f+(d-f)*6*p:p<1/2?d:p<2/3?f+(d-f)*(2/3-p)*6:f}var a,l,u;if(s==0)a=l=u=i;else{var c=i<.5?i*(1+s):i+s-i*s,h=2*i-c;a=o(h,c,n+1/3),l=o(h,c,n),u=o(h,c,n-1/3)}return"rgba("+a*255+","+l*255+","+u*255+","+r+")"}function iv(e){if(H.rgb(e))return ev(e);if(H.hex(e))return nv(e);if(H.hsl(e))return sv(e)}function Se(e){var t=/[+-]?\d*\.?\d+(?:\.\d+)?(?:[eE][+-]?\d+)?(%|px|pt|em|rem|in|cm|mm|ex|ch|pc|vw|vh|vmin|vmax|deg|rad|turn)?$/.exec(e);if(t)return t[1]}function rv(e){if(is(e,"translate")||e==="perspective")return"px";if(is(e,"rotate")||is(e,"skew"))return"deg"}function eo(e,t){return H.fnc(e)?e(t.target,t.id,t.total):e}function ye(e,t){return e.getAttribute(t)}function $o(e,t,n){var s=Se(t);if(Go([n,"deg","rad","turn"],s))return t;var i=ri.CSS[t+n];if(!H.und(i))return i;var r=100,o=document.createElement(e.tagName),a=e.parentNode&&e.parentNode!==document?e.parentNode:document.body;a.appendChild(o),o.style.position="absolute",o.style.width=r+n;var l=r/o.offsetWidth;a.removeChild(o);var u=l*parseFloat(t);return ri.CSS[t+n]=u,u}function ch(e,t,n){if(t in e.style){var s=t.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase(),i=e.style[t]||getComputedStyle(e).getPropertyValue(s)||"0";return n?$o(e,i,n):i}}function Wo(e,t){if(H.dom(e)&&!H.inp(e)&&(!H.nil(ye(e,t))||H.svg(e)&&e[t]))return"attribute";if(H.dom(e)&&Go(Qx,t))return"transform";if(H.dom(e)&&t!=="transform"&&ch(e,t))return"css";if(e[t]!=null)return"object"}function uh(e){if(H.dom(e)){for(var t=e.style.transform||"",n=/(\w+)\(([^)]*)\)/g,s=new Map,i;i=n.exec(t);)s.set(i[1],i[2]);return s}}function ov(e,t,n,s){var i=is(t,"scale")?1:0+rv(t),r=uh(e).get(t)||i;return n&&(n.transforms.list.set(t,r),n.transforms.last=t),s?$o(e,r,s):r}function Vo(e,t,n,s){switch(Wo(e,t)){case"transform":return ov(e,t,s,n);case"css":return ch(e,t,n);case"attribute":return ye(e,t);default:return e[t]||0}}function Xo(e,t){var n=/^(\*=|\+=|-=)/.exec(e);if(!n)return e;var s=Se(e)||0,i=parseFloat(t),r=parseFloat(e.replace(n[0],""));switch(n[0][0]){case"+":return i+r+s;case"-":return i-r+s;case"*":return i*r+s}}function hh(e,t){if(H.col(e))return iv(e);if(/\s/g.test(e))return e;var n=Se(e),s=n?e.substr(0,e.length-n.length):e;return t?s+t:s}function Yo(e,t){return Math.sqrt(Math.pow(t.x-e.x,2)+Math.pow(t.y-e.y,2))}function av(e){return Math.PI*2*ye(e,"r")}function lv(e){return ye(e,"width")*2+ye(e,"height")*2}function cv(e){return Yo({x:ye(e,"x1"),y:ye(e,"y1")},{x:ye(e,"x2"),y:ye(e,"y2")})}function fh(e){for(var t=e.points,n=0,s,i=0;i<t.numberOfItems;i++){var r=t.getItem(i);i>0&&(n+=Yo(s,r)),s=r}return n}function uv(e){var t=e.points;return fh(e)+Yo(t.getItem(t.numberOfItems-1),t.getItem(0))}function dh(e){if(e.getTotalLength)return e.getTotalLength();switch(e.tagName.toLowerCase()){case"circle":return av(e);case"rect":return lv(e);case"line":return cv(e);case"polyline":return fh(e);case"polygon":return uv(e)}}function hv(e){var t=dh(e);return e.setAttribute("stroke-dasharray",t),t}function fv(e){for(var t=e.parentNode;H.svg(t)&&H.svg(t.parentNode);)t=t.parentNode;return t}function ph(e,t){var n=t||{},s=n.el||fv(e),i=s.getBoundingClientRect(),r=ye(s,"viewBox"),o=i.width,a=i.height,l=n.viewBox||(r?r.split(" "):[0,0,o,a]);return{el:s,viewBox:l,x:l[0]/1,y:l[1]/1,w:o,h:a,vW:l[2],vH:l[3]}}function dv(e,t){var n=H.str(e)?lh(e)[0]:e,s=t||100;return function(i){return{property:i,el:n,svg:ph(n),totalLength:dh(n)*(s/100)}}}function pv(e,t,n){function s(c){c===void 0&&(c=0);var h=t+c>=1?t+c:0;return e.el.getPointAtLength(h)}var i=ph(e.el,e.svg),r=s(),o=s(-1),a=s(1),l=n?1:i.w/i.vW,u=n?1:i.h/i.vH;switch(e.property){case"x":return(r.x-i.x)*l;case"y":return(r.y-i.y)*u;case"angle":return Math.atan2(a.y-o.y,a.x-o.x)*180/Math.PI}}function Ol(e,t){var n=/[+-]?\d*\.?\d+(?:\.\d+)?(?:[eE][+-]?\d+)?/g,s=hh(H.pth(e)?e.totalLength:e,t)+"";return{original:s,numbers:s.match(n)?s.match(n).map(Number):[0],strings:H.str(e)||t?s.split(n):[]}}function qo(e){var t=e?Ci(H.arr(e)?e.map(Rl):Rl(e)):[];return Ai(t,function(n,s,i){return i.indexOf(n)===s})}function mh(e){var t=qo(e);return t.map(function(n,s){return{target:n,id:s,total:t.length,transforms:{list:uh(n)}}})}function mv(e,t){var n=Ho(t);if(/^spring/.test(n.easing)&&(n.duration=oh(n.easing)),H.arr(e)){var s=e.length,i=s===2&&!H.obj(e[0]);i?e={value:e}:H.fnc(t.duration)||(n.duration=t.duration/s)}var r=H.arr(e)?e:[e];return r.map(function(o,a){var l=H.obj(o)&&!H.pth(o)?o:{value:o};return H.und(l.delay)&&(l.delay=a?0:t.delay),H.und(l.endDelay)&&(l.endDelay=a===r.length-1?t.endDelay:0),l}).map(function(o){return Si(o,n)})}function gv(e){for(var t=Ai(Ci(e.map(function(r){return Object.keys(r)})),function(r){return H.key(r)}).reduce(function(r,o){return r.indexOf(o)<0&&r.push(o),r},[]),n={},s=function(r){var o=t[r];n[o]=e.map(function(a){var l={};for(var u in a)H.key(u)?u==o&&(l.value=a[u]):l[u]=a[u];return l})},i=0;i<t.length;i++)s(i);return n}function xv(e,t){var n=[],s=t.keyframes;s&&(t=Si(gv(s),t));for(var i in t)H.key(i)&&n.push({name:i,tweens:mv(t[i],e)});return n}function vv(e,t){var n={};for(var s in e){var i=eo(e[s],t);H.arr(i)&&(i=i.map(function(r){return eo(r,t)}),i.length===1&&(i=i[0])),n[s]=i}return n.duration=parseFloat(n.duration),n.delay=parseFloat(n.delay),n}function _v(e,t){var n;return e.tweens.map(function(s){var i=vv(s,t),r=i.value,o=H.arr(r)?r[1]:r,a=Se(o),l=Vo(t.target,e.name,a,t),u=n?n.to.original:l,c=H.arr(r)?r[0]:u,h=Se(c)||Se(l),f=a||h;return H.und(o)&&(o=u),i.from=Ol(c,f),i.to=Ol(Xo(o,c),f),i.start=n?n.end:0,i.end=i.start+i.delay+i.duration+i.endDelay,i.easing=Do(i.easing,i.duration),i.isPath=H.pth(r),i.isPathTargetInsideSVG=i.isPath&&H.svg(t.target),i.isColor=H.col(i.from.original),i.isColor&&(i.round=1),n=i,i})}var gh={css:function(e,t,n){return e.style[t]=n},attribute:function(e,t,n){return e.setAttribute(t,n)},object:function(e,t,n){return e[t]=n},transform:function(e,t,n,s,i){if(s.list.set(t,n),t===s.last||i){var r="";s.list.forEach(function(o,a){r+=a+"("+o+") "}),e.style.transform=r}}};function xh(e,t){var n=mh(e);n.forEach(function(s){for(var i in t){var r=eo(t[i],s),o=s.target,a=Se(r),l=Vo(o,i,a,s),u=a||Se(l),c=Xo(hh(r,u),l),h=Wo(o,i);gh[h](o,i,c,s.transforms,!0)}})}function yv(e,t){var n=Wo(e.target,t.name);if(n){var s=_v(t,e),i=s[s.length-1];return{type:n,property:t.name,animatable:e,tweens:s,duration:i.end,delay:s[0].delay,endDelay:i.endDelay}}}function bv(e,t){return Ai(Ci(e.map(function(n){return t.map(function(s){return yv(n,s)})})),function(n){return!H.und(n)})}function vh(e,t){var n=e.length,s=function(r){return r.timelineOffset?r.timelineOffset:0},i={};return i.duration=n?Math.max.apply(Math,e.map(function(r){return s(r)+r.duration})):t.duration,i.delay=n?Math.min.apply(Math,e.map(function(r){return s(r)+r.delay})):t.delay,i.endDelay=n?i.duration-Math.max.apply(Math,e.map(function(r){return s(r)+r.duration-r.endDelay})):t.endDelay,i}var Ll=0;function wv(e){var t=to(ih,e),n=to(Uo,e),s=xv(n,e),i=mh(e.targets),r=bv(i,s),o=vh(r,n),a=Ll;return Ll++,Si(t,{id:a,children:[],animatables:i,animations:r,duration:o.duration,delay:o.delay,endDelay:o.endDelay})}var oe=[],_h=function(){var e;function t(){!e&&(!jl()||!vt.suspendWhenDocumentHidden)&&oe.length>0&&(e=requestAnimationFrame(n))}function n(i){for(var r=oe.length,o=0;o<r;){var a=oe[o];a.paused?(oe.splice(o,1),r--):(a.tick(i),o++)}e=o>0?requestAnimationFrame(n):void 0}function s(){vt.suspendWhenDocumentHidden&&(jl()?e=cancelAnimationFrame(e):(oe.forEach(function(i){return i._onDocumentVisibility()}),_h()))}return typeof document<"u"&&document.addEventListener("visibilitychange",s),t}();function jl(){return!!document&&document.hidden}function vt(e){e===void 0&&(e={});var t=0,n=0,s=0,i,r=0,o=null;function a(v){var x=window.Promise&&new Promise(function(w){return o=w});return v.finished=x,x}var l=wv(e);a(l);function u(){var v=l.direction;v!=="alternate"&&(l.direction=v!=="normal"?"normal":"reverse"),l.reversed=!l.reversed,i.forEach(function(x){return x.reversed=l.reversed})}function c(v){return l.reversed?l.duration-v:v}function h(){t=0,n=c(l.currentTime)*(1/vt.speed)}function f(v,x){x&&x.seek(v-x.timelineOffset)}function d(v){if(l.reversePlayback)for(var w=r;w--;)f(v,i[w]);else for(var x=0;x<r;x++)f(v,i[x])}function p(v){for(var x=0,w=l.animations,E=w.length;x<E;){var M=w[x],z=M.animatable,k=M.tweens,S=k.length-1,C=k[S];S&&(C=Ai(k,function(Et){return v<Et.end})[0]||C);for(var Y=_e(v-C.start-C.delay,0,C.duration)/C.duration,j=isNaN(Y)?1:C.easing(Y),O=C.to.strings,U=C.round,st=[],Q=C.to.numbers.length,Z=void 0,nt=0;nt<Q;nt++){var D=void 0,V=C.to.numbers[nt],Vt=C.from.numbers[nt]||0;C.isPath?D=pv(C.value,j*V,C.isPathTargetInsideSVG):D=Vt+j*(V-Vt),U&&(C.isColor&&nt>2||(D=Math.round(D*U)/U)),st.push(D)}var tt=O.length;if(!tt)Z=st[0];else{Z=O[0];for(var kt=0;kt<tt;kt++){O[kt];var he=O[kt+1],te=st[kt];isNaN(te)||(he?Z+=te+he:Z+=te+" ")}}gh[M.type](z.target,M.property,Z,z.transforms),M.currentValue=Z,x++}}function g(v){l[v]&&!l.passThrough&&l[v](l)}function m(){l.remaining&&l.remaining!==!0&&l.remaining--}function y(v){var x=l.duration,w=l.delay,E=x-l.endDelay,M=c(v);l.progress=_e(M/x*100,0,100),l.reversePlayback=M<l.currentTime,i&&d(M),!l.began&&l.currentTime>0&&(l.began=!0,g("begin")),!l.loopBegan&&l.currentTime>0&&(l.loopBegan=!0,g("loopBegin")),M<=w&&l.currentTime!==0&&p(0),(M>=E&&l.currentTime!==x||!x)&&p(x),M>w&&M<E?(l.changeBegan||(l.changeBegan=!0,l.changeCompleted=!1,g("changeBegin")),g("change"),p(M)):l.changeBegan&&(l.changeCompleted=!0,l.changeBegan=!1,g("changeComplete")),l.currentTime=_e(M,0,x),l.began&&g("update"),v>=x&&(n=0,m(),l.remaining?(t=s,g("loopComplete"),l.loopBegan=!1,l.direction==="alternate"&&u()):(l.paused=!0,l.completed||(l.completed=!0,g("loopComplete"),g("complete"),!l.passThrough&&"Promise"in window&&(o(),a(l)))))}return l.reset=function(){var v=l.direction;l.passThrough=!1,l.currentTime=0,l.progress=0,l.paused=!0,l.began=!1,l.loopBegan=!1,l.changeBegan=!1,l.completed=!1,l.changeCompleted=!1,l.reversePlayback=!1,l.reversed=v==="reverse",l.remaining=l.loop,i=l.children,r=i.length;for(var x=r;x--;)l.children[x].reset();(l.reversed&&l.loop!==!0||v==="alternate"&&l.loop===1)&&l.remaining++,p(l.reversed?l.duration:0)},l._onDocumentVisibility=h,l.set=function(v,x){return xh(v,x),l},l.tick=function(v){s=v,t||(t=s),y((s+(n-t))*vt.speed)},l.seek=function(v){y(c(v))},l.pause=function(){l.paused=!0,h()},l.play=function(){l.paused&&(l.completed&&l.reset(),l.paused=!1,oe.push(l),h(),_h())},l.reverse=function(){u(),l.completed=!l.reversed,h()},l.restart=function(){l.reset(),l.play()},l.remove=function(v){var x=qo(v);yh(x,l)},l.reset(),l.autoplay&&l.play(),l}function Nl(e,t){for(var n=t.length;n--;)Go(e,t[n].animatable.target)&&t.splice(n,1)}function yh(e,t){var n=t.animations,s=t.children;Nl(e,n);for(var i=s.length;i--;){var r=s[i],o=r.animations;Nl(e,o),!o.length&&!r.children.length&&s.splice(i,1)}!n.length&&!s.length&&t.pause()}function Av(e){for(var t=qo(e),n=oe.length;n--;){var s=oe[n];yh(t,s)}}function Cv(e,t){t===void 0&&(t={});var n=t.direction||"normal",s=t.easing?Do(t.easing):null,i=t.grid,r=t.axis,o=t.from||0,a=o==="first",l=o==="center",u=o==="last",c=H.arr(e),h=parseFloat(c?e[0]:e),f=c?parseFloat(e[1]):0,d=Se(c?e[1]:e)||0,p=t.start||0+(c?h:0),g=[],m=0;return function(y,v,x){if(a&&(o=0),l&&(o=(x-1)/2),u&&(o=x-1),!g.length){for(var w=0;w<x;w++){if(!i)g.push(Math.abs(o-w));else{var E=l?(i[0]-1)/2:o%i[0],M=l?(i[1]-1)/2:Math.floor(o/i[0]),z=w%i[0],k=Math.floor(w/i[0]),S=E-z,C=M-k,Y=Math.sqrt(S*S+C*C);r==="x"&&(Y=-S),r==="y"&&(Y=-C),g.push(Y)}m=Math.max.apply(Math,g)}s&&(g=g.map(function(O){return s(O/m)*m})),n==="reverse"&&(g=g.map(function(O){return r?O<0?O*-1:-O:Math.abs(m-O)}))}var j=c?(f-h)/m:h;return p+j*(Math.round(g[v]*100)/100)+d}}function Sv(e){e===void 0&&(e={});var t=vt(e);return t.duration=0,t.add=function(n,s){var i=oe.indexOf(t),r=t.children;i>-1&&oe.splice(i,1);function o(f){f.passThrough=!0}for(var a=0;a<r.length;a++)o(r[a]);var l=Si(n,to(Uo,e));l.targets=l.targets||e.targets;var u=t.duration;l.autoplay=!1,l.direction=t.direction,l.timelineOffset=H.und(s)?u:Xo(s,u),o(t),t.seek(l.timelineOffset);var c=vt(l);o(c),r.push(c);var h=vh(r,e);return t.delay=h.delay,t.endDelay=h.endDelay,t.duration=h.duration,t.seek(0),t.reset(),t.autoplay&&t.play(),t},t}vt.version="3.2.1";vt.speed=1;vt.suspendWhenDocumentHidden=!0;vt.running=oe;vt.remove=Av;vt.get=Vo;vt.set=xh;vt.convertPx=$o;vt.path=dv;vt.setDashoffset=hv;vt.stagger=Cv;vt.timeline=Sv;vt.easing=Do;vt.penner=ah;vt.random=function(e,t){return Math.floor(Math.random()*(t-e+1))+e};function Mv(e){return ql()?(Oh(e),!0):!1}function Pv(e){return typeof e=="function"?e():rn(e)}const Tv=typeof window<"u"&&typeof document<"u";typeof WorkerGlobalScope<"u"&&globalThis instanceof WorkerGlobalScope;const kv=Tv?window:void 0;function Ev(){const e=se(!1),t=Nc();return t&&In(()=>{e.value=!0},t),e}function Iv(e){const t=Ev();return wo(()=>(t.value,!!e()))}function Fv(e,t={}){const{window:n=kv}=t,s=Iv(()=>n&&"matchMedia"in n&&typeof n.matchMedia=="function");let i;const r=se(!1),o=u=>{r.value=u.matches},a=()=>{i&&("removeEventListener"in i?i.removeEventListener("change",o):i.removeListener(o))},l=Cf(()=>{s.value&&(a(),i=n.matchMedia(Pv(e)),"addEventListener"in i?i.addEventListener("change",o):i.addListener(o),r.value=i.matches)});return Mv(()=>{l(),a(),i=void 0}),r}const Bv={class:"c-shader-title"},zv=ie("h2",{class:"c-subtitle"},"SHADERS",-1),Rv={key:0,class:"p-gallery"},Ov=["onClick","onMouseenterPassiveCapture"],Lv={class:"item__container"},jv=["value"],Nv={class:"c-share"},Uv={href:"mailto:nanonum@gmail.com"},Dv={href:"https://linktr.ee/nanonum",target:"_blank"},Gv={__name:"App",setup(e){const t=Fv("(max-width: 860px)"),n=se(!1);se("shader");const s=se(!1),i=t?85/375*window.innerWidth:110,r=rs({saturation:1});se("");const o=se(),a=rs({selected:!1,stage:"shader",shader:null,title:null,path:null});let l=se();l.value=Object.assign({"/src/shaders/_adot.frag":Qd,"/src/shaders/_cos2.frag":t0,"/src/shaders/_cos3.frag":n0,"/src/shaders/_grad.frag":i0,"/src/shaders/_hole.frag":o0,"/src/shaders/_loading.frag":l0,"/src/shaders/_yu.frag":u0,"/src/shaders/category/_categorized.frag":f0,"/src/shaders/dct.frag":p0,"/src/shaders/flare.frag":g0,"/src/shaders/fog.frag":v0,"/src/shaders/internet.frag":y0,"/src/shaders/line.frag":w0,"/src/shaders/metaball.frag":C0,"/src/shaders/metaball2.frag":M0,"/src/shaders/moire.frag":T0,"/src/shaders/oil.frag":E0,"/src/shaders/pattern.frag":F0,"/src/shaders/ring.frag":z0,"/src/shaders/ring2.frag":O0,"/src/shaders/shower.frag":j0,"/src/shaders/splat.frag":U0,"/src/shaders/up.frag":G0,"/src/shaders/wip.frag":$0});const u=y=>(new URL(y,location),y.split("/").pop());async function c(){if(window.ui=new To,await window.ui.init({backgroundAlpha:0,resizeTo:window,resolution:1}),window.ui.ticker.maxFPS=20,window.ui.canvas.setAttribute("id","canvas_ui"),document.body.appendChild(window.ui.canvas),await dc(),location.hash){const y=location.hash.split("#")[1]||null,v=location.hash.split("#/shader/")[1]||null;a.path=y,a.filename=v;const x=Object.keys(l.value).find(w=>w.slice(w.lastIndexOf("/")+1)===v);a.shader=l.value[x].default}n.value=!0}const h=wo(()=>location.href);In(()=>{c()}),pi(()=>{window.ui&&window.ui.destroy({removeView:!0})});function f(){o.value.select()}const d=(y,v,x)=>{a.selected&&a.title===x?a.selected=null:Object.assign(a,{selected:!!x,shader:v,path:location.hash=`/${y}/${x}`,title:x,stage:y})},p=()=>{history.pushState("","","/nngl/"),a.selected=!1},g=()=>{s.value=!s.value,document.body.classList.toggle("--fullscreen")},m=(y,v,x)=>{console.log(n.value),!a.selected&&Object.assign(a,{shader:v,path:`/${y}/${x}`,title:x,stage:y})};return wn(()=>a.shader,y=>{vt({targets:r,saturation:a.shader?0:1,easing:"easeOutExpo",duration:800})}),(y,v)=>(ge(),ze(Lt,null,[ie("h1",Bv,Ds(a.title||"NN.GL"),1),zv,n.value?(ge(),ze("ul",Rv,[(ge(!0),ze(Lt,null,Nf(rn(l),(x,w)=>(ge(),ze(Lt,null,[u(w).indexOf("_")!==0?(ge(),ze("li",{key:0,class:_s(["p-gallery__item",{active:a.path===`/shader/${u(w)}`}]),onClick:E=>d("shader",x.default,u(w)),onMouseenterPassiveCapture:E=>m("shader",x.default,u(w))},[ie("div",Lv,[It(Zx,{shader:x.default,saturation:r.saturation,width:rn(i),height:rn(i),alt:u(w),selected:a.selected,active:a.title===u(w),show:!s.value},null,8,["shader","saturation","width","height","alt","selected","active","show"])])],42,Ov)):pn("",!0)],64))),256))])):pn("",!0),pn("",!0),n.value&&a.stage==="shader"?(ge(),Lc(Vx,{key:2,shader:a.shader},null,8,["shader"])):pn("",!0),It(ts,{name:"closeButton"},{default:Hs(()=>[a.selected?(ge(),ze("nav",{key:0,onClick:v[1]||(v[1]=x=>p()),class:"c-close"})):pn("",!0)]),_:1}),It(ts,{name:"fullscreenButton"},{default:Hs(()=>[ie("nav",{onClick:v[2]||(v[2]=x=>g()),class:"c-fullscreen"})]),_:1}),It(ts,{name:"permalink"},{default:Hs(()=>[n.value&&a.selected?(ge(),ze("input",{key:0,type:"text",value:h.value,class:"permalink",readonly:"",onClick:v[3]||(v[3]=x=>f()),ref_key:"input_permalink",ref:o},null,8,jv)):pn("",!0)]),_:1}),ie("div",Nv,[ie("a",Uv,Ds(rn(t)?"CONTACT":"nanonum@gmail.com"),1),ie("a",Dv,Ds(rn(t)?"MORE LINKS":"linktr.ee/nanonum"),1)])],64))}};Yd(Gv).mount("#app");export{Wm as $,Bu as A,jt as B,Rt as C,xt as D,q as E,Mu as F,_i as G,qa as H,Tn as I,Jp as J,fm as K,At as L,at as M,wt as N,Em as O,_t as P,Qa as Q,Nr as R,um as S,Fs as T,am as U,Ip as V,Vi as W,yt as X,eu as Y,ut as Z,ct as _,Rr as a,Pn as a0,ii as a1,jg as a2,wl as a3,Hu as a4,Sl as a5,$g as a6,vs as a7,mt as a8,op as a9,Zr as aa,Al as ab,Wu as ac,ce as b,We as c,rt as d,Jt as e,fs as f,lm as g,qm as h,al as i,Qm as j,xs as k,qs as l,ju as m,ja as n,Mo as o,Eu as p,hu as q,xp as r,bl as s,rp as t,Jm as u,Ym as v,Tt as w,we as x,Jc as y,Me as z};
